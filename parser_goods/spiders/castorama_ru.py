...
class CastoramaRuSpider(scrapy.Spider):
    ...
    def goods_parse(self, response: HtmlResponse):
        ...
        loader.add_xpath('images', "//div[@class='js-zoom-container']/img/@src")
        loader.add_xpath('product_description_keys', "//div[contains(@class, 'product-block')]//dl[contains(@class, 'specs-table')]/dt/span[contains(@class, 'specs-table__attribute-name')]/text()")
        loader.add_xpath('product_description_values', "//div[contains(@class, 'specifications')]//dd[contains(@class, 'specs-table__attribute-value')]/text()")
